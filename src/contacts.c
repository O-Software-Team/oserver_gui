...
/* FULL NAME BANNER HERE */
    ...
    /* Contact Name field */
    lv_obj_align(contact_name, LV_ALIGN_TOP_MID, 0, 110);
    lv_obj_set_style_text_color(contact_name, lv_color_white(), 0);
...
/* MOBILE NUMBER FIELD HERE */
    ...
    lv_obj_align(contact_m_phone, LV_ALIGN_LEFT_MID, CONTACT_PAD_LEFT, -60);
...
/* EMAIL FIELD HERE */
    ...
    /* Contact Email field */
    lv_obj_align(contact_p_email, LV_ALIGN_LEFT_MID, CONTACT_PAD_LEFT, -30);
...
/* COMPANY NAME FIELD HERE */
    ...
    /* Contact Name field */
    lv_obj_align(contact_company_name, LV_ALIGN_LEFT_MID, CONTACT_PAD_LEFT, 0);
...
/* NOTES FIELD HERE */
    ...
    /* Contact Name field */
    lv_obj_align(contact_notes, LV_ALIGN_LEFT_MID, CONTACT_PAD_LEFT, 30);
    ...
    lv_obj_align(list_item_separator[CONTACT_ID], LV_ALIGN_LEFT_MID, LIST_SEPARATOR, 70);
