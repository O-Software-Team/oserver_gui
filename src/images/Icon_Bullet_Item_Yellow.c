...
#ifndef LV_ATTRIBUTE_IMG_ICON_BULLET_ITEM_YELLOW
#define LV_ATTRIBUTE_IMG_ICON_BULLET_ITEM_YELLOW
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_ICON_BULLET_ITEM_YELLOW uint8_t Icon_Bullet_Item_Yellow_map[] = {
...
const lv_img_dsc_t Icon_Bullet_Item_Yellow = {
  ...
  .data = Icon_Bullet_Item_Yellow_map,
};
